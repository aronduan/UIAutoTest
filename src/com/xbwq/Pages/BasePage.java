...
import com.xbwq.utils.Locator;
import com.xbwq.utils.XmlUtils;
...
public class BasePage {
    ...
    protected Logger log = MyLogger.log;
    ...
    @FindBy(name = "添加商品")
    WebElement addGoogsButton;
    @FindBy(name = "删除商品")
    WebElement deleteGoogsButton;
    ...
    public BasePage(AndroidDriver driver, String pageName) throws Exception {
        this.driver = driver;
        this.pageName = pageName;
        PageFactory.initElements(driver, this);
        //获取page.xml的路径
        xmlPath = "src/com/xbwq/utils/page.xml";
        locatorMap = XmlUtils.readXMLDocument(xmlPath, pageName);
    }


    public void click(String locatorName) {
        MobileElement element = findElement(locatorName);
        element.click();
    }

    public void sendKeys(String locatorName, CharSequence...charSequences) {
        MobileElement element = findElement(locatorName);
    ...
    public MobileElement findElement(String locatorName) {
        ...
        switch (getLocator(locatorName).getBy()) {
            case xpath:
                e = (MobileElement) driver.findElement(By.xpath(getLocator(locatorName).getAddress()));
                break;
            case id:
                e = (MobileElement) driver.findElement(By.id(getLocator(locatorName).getAddress()));
                break;
            case name:
                e = (MobileElement) driver.findElement(By.name(getLocator(locatorName).getAddress()));
                break;
            case className:
                e = (MobileElement) driver.findElement(By.className(getLocator(locatorName).getAddress()));
                break;
            default:
                e = (MobileElement) driver.findElement(By.id(getLocator(locatorName).getAddress()));
        }
